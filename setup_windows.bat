...
set "XROBOTKIT_CLONED_REPO_PATH=C:\Users\VanSun\Desktop\Internship\PICO\XRoboToolkit-PC-Service-source"
...
:: Using existing local repository at %XROBOTKIT_CLONED_REPO_PATH%
echo Using existing local repository: %XROBOTKIT_CLONED_REPO_PATH%
...
:cleanup_and_exit
:: No temporary directory to clean up as we're using an existing local repository
